...
export const HyosanChatLanguages: Record<
  HyosanChatLanguage,
  HyosanChatLanguageItem
> = {
  [HyosanChatLanguage.en]: { i18nKey: HyosanChatLanguage.en, translation: en },
  [HyosanChatLanguage.zhCn]: {
    i18nKey: HyosanChatLanguage.zhCn,
    translation: zhCn,
  },
}
...
export class LocalizeController extends DefaultLocalizationController<Translation> {
  ...
  static {
    Object.values(HyosanChatLanguages).forEach((lang) =>
      registerTranslation(lang.translation),
    )
  }
}
