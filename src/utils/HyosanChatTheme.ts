...
export const HyosanChatShoelaceThemes: Record<HyosanChatShoelaceTheme, HyosanChatThemeItem> = {
  /** light theme */
  [HyosanChatShoelaceTheme.shoelaceLight]: { i18nKey: 'lightTheme', cssText: shoelaceLightCss, },
  /** dark theme */
  [HyosanChatShoelaceTheme.shoelaceDark]: { i18nKey: 'darkTheme', cssText: shoelaceDarkCss, },
